...
/** Sunday email section: sits after the article close, before FAQ. */
export function GuideEmailCta({ source }: { source: string }) {
  return (
    <aside
      id="sunday-email"
      className="my-10 scroll-mt-24 rounded-2xl border border-rule border-l-[3px] border-l-pine bg-paper-2 px-5 py-6 sm:px-6"
