...
| School clothes for two kids without a mall meltdown | live | 2026-08-25 | [`school-clothes-for-two-kids.md`](guides/school-clothes-for-two-kids.md) — traffic test #1, homepage spotlight |
| The sports fee that is not on the registration form | live | 2026-08-25 | [`the-sports-fee-not-on-the-form.md`](guides/the-sports-fee-not-on-the-form.md) — traffic test #2, homepage spotlight |
| Chores aren't a paycheck (the hybrid allowance) | live | 2026-08-25 | [`chores-arent-a-paycheck.md`](guides/chores-arent-a-paycheck.md) — traffic test #3, published not spotlighted |
