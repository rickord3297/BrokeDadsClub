...
**A yes-list.** Decide in advance what you say yes to: the library, the park, one friend hang a weekend, one paid thing a month. Everything else is a default no, which is kinder than a last-minute scramble.

**A sinking fund with an ugly name.** "Birthday/school/random kid tax" in a separate savings bucket. $20 a paycheck is not glamorous. It is how you avoid putting a classroom gift on a credit card.
